"""
This script generates time and memory benchmark plots for PyFraug and tsaug augmenters. It uses the csv
...
def main():
    ...
    and generates plots comparing PyFraug and tsaug augmenters.
    """
    ...
    plt.ylabel("Peak Memory (MB)")
    plt.title(
        f"{dataset_name} Dataset Time vs Memory: PyFraug vs tsaug (per augmenter)"
    )
    plt.legend()
    plt.tight_layout()
